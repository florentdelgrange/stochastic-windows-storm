...
namespace storm {
    namespace storage {
        ...
        public:
            ...
            uint_fast64_t getSuccessorMemoryState(storm::models::sparse::Model<ValueType, RewardModelType> const& model,
                                                  uint_fast64_t const& currentMemoryState,
                                                  uint_fast64_t const& currentModelState,
                                                  uint_fast64_t const& choice,
